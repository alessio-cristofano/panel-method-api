...
!CALL OUTFILE()
!
open(6,	file =	'out/output_ibjb'//trim(strib)//trim(strjb)//'_b'//trim(strb)//&
		'_aoa'//trim(stra)//'_v'//trim(strv)//'.txt') 
open(7,	file =	'out/cl_vs_t_ibjb'//trim(strib)//trim(strjb)//'_b'//trim(strb)//&
		'_aoa'//trim(stra)//'_v'//trim(strv)//'.txt') 
!open(8,	file =	'out/p17out_ibjb'//trim(strib)//trim(strjb)//'_b'//trim(strb)//&
!		'_aoa'//trim(stra)//'_v'//trim(strv)//'.txt') 
open(9, file =  'out/wakepoints.txt')
open(17,file = 'out/cpmid_ibjb'//trim(strib)//trim(strjb)//'_b'//trim(strb)//&
		'_aoa'//trim(stra)//'_v'//trim(strv)//'.txt')
open(19, file =  'out/wake3d.txt')
open(66,file =	'out/wakegnd_ibjb'//trim(strib)//trim(strjb)//'_b'//trim(strb)//&
		'_aoa'//trim(stra)//'_v'//trim(strv)//'.txt') 
!                                                                       
PAY=acos(-1.) 
FOURPAY = 4.*PAY 
...
!                                                                       
    ...
    104   FORMAT(1H ,'N=',I3,2X,'CL=',F10.4,2X,'L=',F10.4,4X,'CM=',F10.4,3X,'CD=',F10.4) 
    IF(N.EQ.1) THEN 
